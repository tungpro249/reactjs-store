    ...
    <Grid container pr={20} pl={20} pt={3} pb={3}>
      <Grid item xs={12} md={6}>
        ...
        <p>
          ...
          2002. Với tư cách là một biểu tượng trong ngành thời trang nam Việt Nam, Frenzy tự hào đã
          đóng góp vào sự thay đổi và phát triển của diện mạo thời trang trong nước, với sứ mệnh
          đồng hành cùng xu hướng thời trang quốc tế.
          <br />
          <br />
          Các thiết kế của Frenzy mang đến sự đơn giản nhưng tinh tế, kết hợp giữa vẻ thanh lịch và
          nét đẹp truyền thống của người Á Đông. Thương hiệu này đặt công sức lớn vào việc thiết kế
          sản phẩm, chú trọng đến các chi tiết cắt may tinh tế và lựa chọn chất liệu cao cấp. Đội
          ngũ nhà thiết kế của Frenzy luôn tin rằng một bộ trang phục dành cho phái mạnh Việt không
          chỉ cần mang đến vẻ sang trọng và quyến rũ, mà còn cần phải vừa vặn và phù hợp với vóc
          dáng và phong cách cá nhân của người đàn ông Á Đông.
          <br />
          <br />
          Frenzy mang đến bốn dòng sản phẩm chính: NEM New, NEM Luxury Limited, Homewear, mỗi dòng
          sản phẩm đều có những nét đặc trưng riêng trong thiết kế. Thông qua sự đa dạng này, Frenzy
          tự tin đáp ứng giải pháp thời trang phù hợp với nhiều độ tuổi, phong cách ăn mặc và hoàn
          cảnh sử dụng khác nhau của khách hàng.
          <br />
          <br />
